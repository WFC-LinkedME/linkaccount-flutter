package cc.linkedme.linkaccount;
 ...
 * LinkaccountPlugin
 */
public class LinkaccountPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onAttachedToEngine(FlutterPluginBinding flutterPluginBinding) {
        ...
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "linkaccount");
